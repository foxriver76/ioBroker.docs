...
![TR: Number of Installations](http://iobroker.live/badges/deconz-stable.svg)
![TR: NPM version](http://img.shields.io/npm/v/iobroker.deconz.svg)
![TR: Downloads](https://img.shields.io/npm/dm/iobroker.deconz.svg)
![TR: NPM](https://nodei.co/npm/iobroker.deconz.png?downloads=true)

TR: ioBroker deConz dresden-elektronik Adapter

==============

TR: ## Notice
TR: No Support for Beta Versions of deConz

TR: Required js-controller version >2.x.x, Required node.js >= 10.x.x

TR: ## English
TR: Connects to deConz software developed by dresden-elektronik. This software aims to be a universal ZigBee Gateway solution, using hardware from dresden-elektronik the ConBee USB stick and RaspBee a modul for the Raspberry Pi.

TR: You must first link to deConz.

TR: 1.  a) Enter ip address for deConz

TR:     b) Enter port number, standard is 80.

TR: 2. After IP address and port is entered and saved hit "Create API Key" Button. Now you can enter the credentials for deConz or go to Phoscon APP and register ioBroker as third party APP.

TR: #### Send more than one command at the same time
TR: For this purpose there is a object called "action".

TR: Examples:

TR: `"on": true, "xy": [0.6586,0.3138]`

TR: `"on": true, "transitiontime": 5, "hue": 65500`

TR: ## Links
TR: [TR: deConz](https://www.dresden-elektronik.de/funktechnik/products/software/pc/deconz/) [TR: REST plugin](https://github.com/dresden-elektronik/deconz-rest-plugin) [TR: Gateways (Hardware)](https://www.dresden-elektronik.de/funktechnik/solutions/wireless-light-control/gateways/)

## [TR: Sponsors](https://github.com/iobroker-community-adapters/ioBroker.deconz/blob/master/SPONSORS.MD)
